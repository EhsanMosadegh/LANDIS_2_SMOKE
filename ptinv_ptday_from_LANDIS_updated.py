...
if (user_input == 'n' or user_input == 'N' or user_input == 'no'):
    ...
    #threshold = 0.00001
    filter_NonZero = (input_csv['Heat-25'] != 0) & (input_csv['NOx-Flaming'] != 0) & (input_csv['N2O-Flaming-25'] != 0)
    #print('HFLUX threshold is set to = %s' %threshold)
...
#########################################################################################################
    ...
    #        'CO_S':['CO',df_input_F_NoZero['CO-Smoldering'][LANDISrow],'2810001001'],
    #        'CO_F':['CO',df_input_F_NoZero['CO-Flaming'][LANDISrow],'2810001002'],
    #        'CO2_S':['CO2',df_input_F_NoZero['CO2-Smoldering'][LANDISrow],'2810001001'],
    #        'CO2_F':['CO2',df_input_F_NoZero['CO2-Flaming'][LANDISrow],'2810001002'],
    #        'CH4_S':['CH4',df_input_F_NoZero['CH4-Smoldering'][LANDISrow],'2810001001'],
    #        'CH4_F':['CH4',df_input_F_NoZero['CH4-Flaming'][LANDISrow],'2810001002'],
    #        'SO2_S':['SO2',df_input_F_NoZero['SO2-Smoldering-25'][LANDISrow],'2810001001'],
    #        'SO2_F':['SO2',df_input_F_NoZero['SO2-Flaming-25'][LANDISrow],'2810001002'],
    #        'NH3_S':['NH3',df_input_F_NoZero['NH3-Smoldering-25'][LANDISrow],'2810001001'],
    #        'NH3_F':['NH3',df_input_F_NoZero['NH3-Flaming-25'][LANDISrow],'2810001002'],
    #        'NMOC_S':['VOC',df_input_F_NoZero['NMOC-Smoldering-25'][LANDISrow],'2810001001'],
    #        'NMOC_F':['VOC',df_input_F_NoZero['NMOC-Flaming-25'][LANDISrow],'2810001002'],
    #        'NOx_S':['NOx',df_input_F_NoZero['NOx-Smoldering'][LANDISrow],'2810001001'],
    #        'NOx_F':['NOx',df_input_F_NoZero['NOx-Flaming'][LANDISrow],'2810001002'],
    #        'PM10_S':['PM10',df_input_F_NoZero['PM10-Smoldering-25'][LANDISrow],'2810001001'],
    #        'PM10_F':['PM10',df_input_F_NoZero['PM10-Flaming-25'][LANDISrow],'2810001002'],
    #        'PM2.5_S':['PM2.5',df_input_F_NoZero['PM2.5-Smoldering-25'][LANDISrow],'2810001001'],
    #        'PM2.5_F':['PM2.5',df_input_F_NoZero['PM2.5-Flaming-25'][LANDISrow],'2810001002'],
    #        'heat_flux':['HFLUX',df_input_F_NoZero['Heat-25'][LANDISrow],'2810001002'],
    #        'acres_burned':['ACRESBURNED',pixel_area_in_Ha,'2810001002'],
    #        }

    # for NEI 2011 - devided SCC mode
    POL_dict_4SCC_devided = {
            'CO_S':['CO',df_input_F_NoZero['CO-Smoldering'][LANDISrow],'28100010S0'],
            'CO_F':['CO',df_input_F_NoZero['CO-Flaming'][LANDISrow],'28100010F0'],
            'CO2_S':['CO2',df_input_F_NoZero['CO2-Smoldering'][LANDISrow],'28100010S0'],
            'CO2_F':['CO2',df_input_F_NoZero['CO2-Flaming'][LANDISrow],'28100010F0'],
            'CH4_S':['CH4',df_input_F_NoZero['CH4-Smoldering'][LANDISrow],'28100010S0'],
            'CH4_F':['CH4',df_input_F_NoZero['CH4-Flaming'][LANDISrow],'28100010F0'],
            'SO2_S':['SO2',df_input_F_NoZero['SO2-Smoldering-25'][LANDISrow],'28100010S0'],
            'SO2_F':['SO2',df_input_F_NoZero['SO2-Flaming-25'][LANDISrow],'28100010F0'],
            'NH3_S':['NH3',df_input_F_NoZero['NH3-Smoldering-25'][LANDISrow],'28100010S0'],
            'NH3_F':['NH3',df_input_F_NoZero['NH3-Flaming-25'][LANDISrow],'28100010F0'],
            'NMOC_S':['VOC',df_input_F_NoZero['NMOC-Smoldering-25'][LANDISrow],'28100010S0'],
            'NMOC_F':['VOC',df_input_F_NoZero['NMOC-Flaming-25'][LANDISrow],'28100010F0'],
            'NOx_S':['NOX',df_input_F_NoZero['NOx-Smoldering'][LANDISrow],'28100010S0'],
            'NOx_F':['NOX',df_input_F_NoZero['NOx-Flaming'][LANDISrow],'28100010F0'],
            'PM10_S':['PM10',df_input_F_NoZero['PM10-Smoldering-25'][LANDISrow],'28100010S0'],
            'PM10_F':['PM10',df_input_F_NoZero['PM10-Flaming-25'][LANDISrow],'28100010F0'],
            'PM2.5_S':['PM2_5',df_input_F_NoZero['PM2.5-Smoldering-25'][LANDISrow],'28100010S0'],
            'PM2.5_F':['PM2_5',df_input_F_NoZero['PM2.5-Flaming-25'][LANDISrow],'28100010F0'],
            'heat_flux':['HFLUX',df_input_F_NoZero['Heat-25'][LANDISrow],'28100010F0'],
            'acres_burned':['ACRESBURNED',pixel_area_in_Ha,'28100010F0'],
            }

    # for NEI 2011 - total SCC mode
    POL_dict_4SCC_total = {
            'CO_tot':['CO',df_input_F_NoZero['CO-Smoldering'][LANDISrow]+df_input_F_NoZero['CO-Flaming'][LANDISrow],'2810001000'],
            'CO2_tot':['CO2',df_input_F_NoZero['CO2-Smoldering'][LANDISrow]+df_input_F_NoZero['CO2-Flaming'][LANDISrow],'2810001000'],
            'CH4_tot':['CH4',df_input_F_NoZero['CH4-Smoldering'][LANDISrow]+df_input_F_NoZero['CH4-Flaming'][LANDISrow],'2810001000'],
            'SO2_tot':['SO2',df_input_F_NoZero['SO2-Smoldering-25'][LANDISrow]+df_input_F_NoZero['SO2-Flaming-25'][LANDISrow],'2810001000'],
            'NH3_tot':['NH3',df_input_F_NoZero['NH3-Smoldering-25'][LANDISrow]+df_input_F_NoZero['NH3-Flaming-25'][LANDISrow],'2810001000'],
            'NMOC_tot':['VOC',df_input_F_NoZero['NMOC-Smoldering-25'][LANDISrow]+df_input_F_NoZero['NMOC-Flaming-25'][LANDISrow],'2810001000'],
            'NOx_tot':['NOX',df_input_F_NoZero['NOx-Smoldering'][LANDISrow]+df_input_F_NoZero['NOx-Flaming'][LANDISrow],'2810001000'],
            'PM10_tot':['PM10',df_input_F_NoZero['PM10-Smoldering-25'][LANDISrow]+df_input_F_NoZero['PM10-Flaming-25'][LANDISrow],'2810001000'],
            'PM2.5_tot':['PM2_5',df_input_F_NoZero['PM2.5-Smoldering-25'][LANDISrow]+df_input_F_NoZero['PM2.5-Flaming-25'][LANDISrow],'2810001000'],
            'heat_flux':['HFLUX',df_input_F_NoZero['Heat-25'][LANDISrow],'2810001000'],
...
#########################################################################################################
    ...
    total_row_no = df_input_F_NoZero.shape[0]
    ...
    for LANDISrow in range(total_row_no):  # i=LANDIS row number
        ...
        for pol in SCCmode_POList_mapper[mode][0]:  # pol = LANDIS col ; processes all elements inside POL_list_4SCC_devided 1-by-1; and calculates every row of PTDAY
            ...
            LANDIS_Jday = df_input_F_NoZero['Day-of-Fire'][LANDISrow]

            if LANDIS_Jday == 0:

                print('-> fireID %s does not have fire!' %df_input_F_NoZero['FID'][LANDISrow])
                day_str = '001'
            ...
            FIREID = '"'+'FID_'+str(df_input_F_NoZero['FID'][LANDISrow])+'"'
            LOCID = '"'+'PID_'+str(df_input_F_NoZero['pointid'][LANDISrow])+'"'

            # --- set lat/lon ----------------------

            LAT = df_input_F_NoZero['Long'][LANDISrow]
            LON = df_input_F_NoZero['Lat'][LANDISrow]
...
#########################################################################################################
    ...
    print('-> fake data values of %s was replaced at missing fire days!' %DATAVALUE_fake)
    print('-> fake lat= %s and lon= %s was set for missing fire days!' %(LAT_fake , LON_fake))
...
#########################################################################################################
    ...
    # --- for PTDAY
    ptday_output_file_name = 'USFS_LANDIS_PTDAY_month_'+favorite_month+'_mode_'+mode+'_test9.csv'  # must include file format at the end (.csv)
    ...
    # --- for PTINV
    ptinv_output_file_name = 'USFS_LANDIS_PTINV_month_'+favorite_month+'_mode_'+mode+'_test9.csv'  # must include file format at the end (.csv)
